...
figure; plot(t_feb, v_feb); xlabel('Days from 1 Feb 2018 00:00'); ylabel('meridional component of wind, units unknown')
figure; plot(t_Jul_Aug,v_Jul_Aug); xlabel('Days from 1 Jul 2018 00:00'); ylabel('meridional component of wind, units unknown')
